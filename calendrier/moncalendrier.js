...
class moncalendrier {
    ...
    calendrier(mois, annee) {
        ...
        for (let index = 0; index < nbjour2; index++) {
            ...
            html += '<div style="background : white;width: 14%;height : 100px;"></div><br>'
        }
        ...
        for (var i = 1; i < nbjour; i++) {
            ...
            html += '<div onclick="calendrier.click1(\'' + datejour + '\')"  style="background : white;width: 14%;height : 100px;display:flex;justify-content: center;align-items: center;"><div class="valide" id="' + datejour + '" ><span style="color : black">' + i + '</span></div></div><br>';
        }
